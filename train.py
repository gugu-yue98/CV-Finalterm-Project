...
class Pedestrian_Segmentation:
    def __init__(self):
        ...
        # Hyperparameters
        self.root = "D:/研一下/作业/计算机视觉/bottle"
        ...
        self.lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer=self.optimizer, step_size=3, gamma=0.5)
    ...
    def load(self):
        self.mask_RCNN = torch.load(self.weights_path)
